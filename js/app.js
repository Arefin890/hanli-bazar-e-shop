              ...
              <div class="col single-product">
                ...
                border-radius: 10px;">
                   ...
                   <div class="card-body">
                        ...
                        <button style="background-color: #9999FF;border: none;" onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart <i class="fas fa-shopping-cart"></i></button>
